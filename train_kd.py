...
https://github.com/VITA-Group/Nasty-Teacher/blob/main/train_kd.py
"""
import torch
...
parser.add_argument('--save_path', default='experiments/CIFAR10/kd_baseline_resnet18/cnn', type=str)
